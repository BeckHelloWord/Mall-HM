...
<template>
	<div class="ttj">
		<div class="discribe">
			{{this.$public.info.briskLang}}是{{this.$public.info.siteName}}为您精心打造的活期产品，申购{{this.$public.info.briskLang}}的资金投向真实优质债权项目，不仅能够得到超额收益，还能随时提取，方便灵活且不收取任何手续费。
		</div>
		<div class="intro-one">
			<table>
				<tr>
		...
		<div class="intro-one">
			<table>
				...
				<tr>
					...
					<td>体验金、红包等不能申购{{this.$public.info.briskLang}}<br> 持有期间利息按日计算，本金自动复投
					</td>
				</tr>
			</table>
		</div>
