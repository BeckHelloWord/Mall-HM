...
const homeRouter = [{
  ...
  // }, 
  {
    ...
    path: "/home/brisk",
    component: (resolve) => {
      require(['./components/home/brisk.vue'], resolve)
    }
  }, {
    //添添金 - 交易明细
    path: "/home/brisk-transaction",
    component: (resolve) => {
      require(['./components/home/briskTransaction.vue'], resolve)
    }
  }, {
    //添添金 - 赎回详情
    path: "/home/brisk-redeem",
    component: (resolve) => {
      require(['./components/home/briskRedeem.vue'], resolve)
    }
  }, {
    //邀请好友
    path: "/home/invite",
    component: (resolve) => {
      require(['./components/home/invite.vue'], resolve)
    }
  }, {
    //邀请好友列表
    path: "/home/inviteList",
    component: (resolve) => {
      require(['./components/home/inviteList.vue'], resolve)
    }
  },{
  //定期产品-列表
  path: '/home/fixed/list',
  component: (resolve) => {
      require(['./components/home/fixed/list.vue'], resolve)
  }
},{
  //定期产品-详情
  path: '/home/fixed/details/:id',
  component: (resolve) => {
      require(['./components/home/fixed/details.vue'], resolve)
  }
},{
  //定期产品-持标明细
  path: '/home/fixed/stream/:id',
  component: (resolve) => {
      require(['./components/home/fixed/stream.vue'], resolve)
  }
},{
  //邀请好友规则
  path: '/home/inviteRule',
  component: (resolve) => {
    require(['./components/home/inviteRule.vue'], resolve)
  }
}]
